                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">User Profile <?= $user['level'] == 'admin' ? 'Admin' : 'Pimpinan'; ?></h1>
                                    </div>
                                    <div class="card mb-3" style="max-width: 540px;">
                                        <div class="row no-gutters">
                                            <div class="col-md-4 text-center p-2">
                                                <img src="<?= base_url('/assets/img/') . $user['foto_user']; ?>" class="card-img mb-3">
                                                <span class="text-muted"><?= ucfirst($user['username']); ?></span>
                                                <p class="card-text">
                                                    <?php if ($user['status'] == 'Pegawai Tetap') : ?>
                                        ...
                                        <div class="text-center">
                                            <p class="mb-3"><small class="text-muted">PT. Gelumbang Agro Sentosa</small></p>
                                        </div>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="<?= $_SERVER['HTTP_REFERER']; ?>">Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </div>
