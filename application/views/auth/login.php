                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="<?php echo base_url('auth') ?>">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="username" name="username" aria-describedby="userlHelp" placeholder="Enter Username..." value="<?= set_value('username'); ?>">
